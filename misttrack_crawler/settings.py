...
ROOT_URLCONF = 'misttrack_crawler.urls'
...
WSGI_APPLICATION = 'misttrack_crawler.wsgi.application'

ASGI_APPLICATION = 'misttrack_crawler.asgi.application'  # Add ASGI application
